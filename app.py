...
# Load environment variables for API keys and location
...
def forecast():
    try:
        ...
        forecast_url = f"http://api.openweathermap.org/data/2.5/forecast?lat={LAT}&lon={LON}&appid={OPENWEATHER_KEY}"
